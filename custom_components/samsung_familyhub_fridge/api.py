...
class FamilyHub:
    ...
    def update_camera(self):
        """Send the refresh command to the fridge camera.

        Sends the reverse-engineered execute command that triggers the
        Family Hub to capture new photos. Throttled by the coordinator
        via contactSensor door-close events so we don't blast it on
        every poll.
        """
